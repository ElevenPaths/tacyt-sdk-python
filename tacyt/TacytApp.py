...
from ExternalApiMarketAppRequest import (
    ExternalApiMarketNewAppRequest,
    ExternalApiMarketUpdateAppRequest
)
...
class TacytApp(Auth):
    ...
    def add_market_app(self, unique_origin_id, unique_version_id, platform,
        ...
        :param platform: the plaftform of the application: iOS or Android.
        ...
        the api endpoint in snakecase.
        :return: TacytResponse
        """
        externalMarketApp = ExternalApiMarketNewAppRequest(
        ...
        return self.http_post(self.API_MARKET_URL, headers=None, body=externalMarketApp.get_json_encode_for_new_market_app())
    ...
    def update_market_app(self, unique_origin_id, unique_version_id, platform,
        ...
        :return: TacytResponse
        """
        externalMarketApp = ExternalApiMarketUpdateAppRequest(
            unique_origin_id=unique_origin_id,
            unique_version_id=unique_version_id,
            platform=platform,
            origin=origin,
